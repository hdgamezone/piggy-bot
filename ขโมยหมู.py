...
game0 = API_Piggy(login_user[uid],login_token[uid],line_token)


id = 239671288500187

# add = game0.add_friend(id)
# print(add)
# quit()

# pig_id = game0.pig_data(id, 1)
# print(pig_id)
# quit()

chack = game0.chack_steal(id,1)
print(chack)
...
while True:
    try:
        pig_id = game0.pig_data(id,1)
        #print(pig_id)
        for i in pig_id['users_pigs']:
            if i['pig_id'] == '419':
                print(i['pig_id'])
                steal = game0.steal(id,i['id'])
                print(steal)
    except:
        pass